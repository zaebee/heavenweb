...
<script>
  ...
  export default {
    ...
    async fetch ({ store, params, error }) {
      ...
      // await store.dispatch('GET_TOPICS')
      // await store.dispatch('GET_STORIES')
